...
def getBestHyperparameter(w,b):
    ...
    regC = np.array([10,100,1000,9000,10000], 'float');
...
def main():
    print("Average SVM Model Training");
    print("==========================");
    ...
    print("Hyper Parameter selection - Cross Validation");
    print("============================================");
...
#    F1 = 2 * ((p * r) / (p + r));
#    
    print("Final SVM Parameters after Training");
    print("====================================");
