...
def trainModel(xval,yval,b,wval,eta,rows,mu,avgW,avgB):
...
def labelPredict(xeval,yeval,bestWeight,bestBias,rowsEval,mu):
    ...
    fopen = open('../movie-ratings/results/Avg-LR-results-try3.txt', 'w');
...
def getBestHyperparameter(w,b):
    ...
    sigma2 = np.array([10,100,1000,10000], 'float');
    ...
    for mu in sigma2:
        ...
        for eta in gamma:
            ...
            for trainSet in cvTrainx:
                ...
                accuracy = accuracyCalc(cvttx,cvtty,avgW,avgB,rowte,mu);
                #print("Accuracy:",accuracy);
#                if accuracy > accF :
#                    accF = accuracy;
#                    wF = wNew;
...
def main():
    print("Averaged Logistic Regression Training");
    print("=====================================");
    ...
    print("Hyper Parameter Selection using 5 fold Cross Validation");
    print("=======================================================");
    ...
    for epoch in range(0,30):
        ...
        wNew,biasNew,avgWeight,avgBias = trainModel(x,y,biasNew,wNew,eta,rows,mu,avgWeight,avgBias);
        ...
        print("Predicting model accuracy with dev set");
        accuracy = accuracyCalc(xdev,ydev,avgWeight,avgBias,rowsDev,mu);
...
#    
    ...
    print("Test Set loaded. Predicting Accuracy on test set");
